  ...
  if (selectedDisaster) {
    ...
    return (
      <View style={styles.wrapper}>
        ...
        {/* PHASE LABEL */}
        <View style={[styles.phaseLabelRow, { backgroundColor: PHASE_COLORS[selectedPhase] + "15" }]}>
        ...
        <ScrollView style={styles.tipsContainer}>
          {tips.map((tip, index) => (
            <View key={index} style={[styles.tipCard, { borderLeftColor: PHASE_COLORS[selectedPhase] }]}>
              <View style={[styles.tipIconBox, { backgroundColor: PHASE_COLORS[selectedPhase] + "15" }]}>
                <Text style={styles.tipEmoji}>{tip.icon}</Text>
              </View>
              <View style={styles.tipContent}>
                <Text style={styles.tipNumber}>Step {index + 1}</Text>
...
const styles = StyleSheet.create({
  ...
  offlineBanner: {
    backgroundColor: "#E65100", padding: 10,
    alignItems: "center",
  },
  ...
  subHeader: { textAlign: "center", color: COLORS.textLight, marginBottom: 20 },
  offlineCard: {
    flexDirection: "row", backgroundColor: "#FFF3E0",
    borderRadius: 12, padding: 15, marginBottom: 20,
    borderWidth: 1, borderColor: "#FFE0B2", alignItems: "center",
  },
  ...
  offlineCardDesc: { color: "#555", fontSize: 12, marginTop: 3 },
  disasterCard: {
  ...
  disasterTitle: { fontWeight: "bold", fontSize: 17, color: COLORS.textDark, marginBottom: 8 },
  ...
  noteCard: {
    ...
    padding: 15, marginTop: 5, borderWidth: 1,
    borderColor: COLORS.border,
  },
  noteIcon: { fontSize: 24, marginRight: 12 },
  noteText: { flex: 1, color: COLORS.textMid, fontSize: 13 },
  guideHeader: {
    padding: 25, paddingTop: 55, alignItems: "center",
  ...
  phaseTabs: {
    flexDirection: "row", padding: 15, gap: 8,
    borderBottomWidth: 1, borderColor: COLORS.border,
  },
  phaseTab: {
    flex: 1, paddingVertical: 10, borderRadius: 25,
    alignItems: "center", borderWidth: 1.5,
    borderColor: COLORS.border,
  },
  phaseTabText: { fontWeight: "bold", fontSize: 12, color: COLORS.textMid },
  ...
  tipContent: { flex: 1 },
  tipNumber: { fontSize: 11, color: COLORS.textLight, marginBottom: 3 },
